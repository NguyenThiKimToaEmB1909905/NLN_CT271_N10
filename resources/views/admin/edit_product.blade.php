...
@section('admin_content')
    <section>
        <div class="mt-2 p-5 ">
            <h5 class="text-muted my-2">Cập Nhật Sản Phẩm</h5>
            <?php
                    ...
                    <form role="form" action="{{ URL::to('/update-product/' . $pro->product_id) }}" method="post"
                            ...
                            <div class="col">
                                ...
                                <div class="form-outline">
                                    <input type="text" class="form-control" name="product_quantity"
                                        id="exampleInputPassword1" required="" value="{{ $pro->product_quantity }}">
                                    <div class="invalid-feedback">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col">
                                ...
                                <div class="form-outline">
                                    <textarea style="resize:none" rows="5" class="form-control" name="product_desc" placeholder="Mô tả sách">{{ $pro->product_desc }}</textarea>
                                    <div class="invalid-feedback">
                                    </div>
                            ...
                            <div class="col">
                                ...
                                <div class="form-outline">
                                    <textarea style="resize:none" rows="5" class="form-control" name="product_content" placeholder="Nội dung sách">{{ $pro->product_content }}</textarea>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <img src="{{ URL::to('public/uploads/product/' . $pro->product_image) }}" height="50"
                                width="50">
                        </div>
                        <div class="form-outline mb-4">
                        ...
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-primary btn-block mb-4" name=" add_brand_product">Cập nhật
                            sách</button>
                    </form>
